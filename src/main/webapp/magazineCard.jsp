...
<head>
    ...
    <title>Інтернет-магазин журналів - Журнал "${magazine.title}"</title>
</head>
                ...
                <div class="col-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p>Період підписки:<br>
                            <input class="subscribePeriod" type="number" max="12" min="1" value="1"> міс.</p>

                            <button type="button" class="btn btn-primary openModal" data-toggle="modal" data-target="#buyMagazineModal">В корзину</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Оформлення підписки на журнал "${magazine.title}"</h5>
                        ...
                        <script language="javascript">var subscribePeriod = $('.subscribePeriod').val()</script>
                            Ви точно хочете добавити підписку на <span id="subscribePeriod"></span> міс. на журнал "${magazine.title}" в корзину?
                        </div>
